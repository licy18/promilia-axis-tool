...
- C11-R1 is product-accepted at `8f01dba447106b03783582d58e80badb8a571b8e`. C12 source-closes `set-skill:1:4` through `before-skill-composite-runtime-evidence.json` (`10538B / 165b87b2d5ea01f1a2f7f72a828b6a1eeeca19ef1f429003b2dccca457686212`), but reviewed commit `a432467d4322ee0dae58e3d47df3b5c2eb55447a` was rejected because actor-target direct SP granted the source actor's Kibo an unconditional full share. C12-R1 separates direct Kibo target identity from source-owner Kibo routing: source/other Kibos now consume only `mainPetShareType/petShareType`, while Kibo-target direct SP alone receives share 1. C13, M12-C and formal search remain locked.
...
- Status: `B3-C12-R1 verification-complete-awaiting-product-acceptance`.
