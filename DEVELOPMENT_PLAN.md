...
下一阶段：P3 六资源观测回放一致性。固定角色 SP 与奇波就绪观测在方案复制、本地草稿、JSON、分享链接和 PNG 中恢复相同所有者、帧点与曲线结果，并把生产采样缺失与所有者不匹配保持为明确拒绝；不新增公式、倍率或碎片 UI。
...
19. 下一阶段：P3 六资源观测回放一致性，守住五载体中的所有者、准确帧和曲线结果。
