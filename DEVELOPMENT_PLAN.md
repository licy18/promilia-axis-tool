...
- B3-A 基线已由唯一生成命令重算为 `11/43/62/137/12`，source/roster/catalog/binding hash 分别为 `0e2fa93b88d82707`、`6b5961e83e5b1eb7`、`69e0cea8e25f33b4`、`3cf1c9cc678e4193`。版本化培养 profile 已进入 Machine Axis、canonical input hash 与 Workbench round-trip；研究模式保持兼容，正式模式对当前未取得资格的对象在 project 生成前结构化拒绝。当前五类 optimization-ready 均为 0，`62/62` 灵子效果、`12/12` 套装技能、实例档证据和 DNA/角色验收缺口继续硬阻断，不构成部分放行。
