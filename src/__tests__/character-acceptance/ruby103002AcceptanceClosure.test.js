...
describe('Ruby 103002 acceptance closure', () => {
  ...
  it('publishes complete technical and accepted product evidence', () => {
    ...
    expect(manifest.evidence.productVisualAcceptance).toMatchObject({
      ...
      recordIdentity:
        'character-product-acceptance:103002:829d628bff9476c489d03e152e9377fd8c8e9e3c:1341fb521686b889',
      qualificationSubjectHash: '1341fb521686b889',
      scenarioSetHash: '772e03bd84be8025',
