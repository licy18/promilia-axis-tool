...
describe('Ruby 103002 acceptance closure', () => {
  ...
  it('publishes complete technical and accepted product evidence', () => {
    ...
    expect(manifest.evidence.productVisualAcceptance).toMatchObject({
      ...
      recordIdentity:
        'character-product-acceptance:103002:829d628bff9476c489d03e152e9377fd8c8e9e3c:af39e2ab7808d82b',
      qualificationSubjectHash: 'af39e2ab7808d82b',
      scenarioSetHash: 'f8fa50a894427c98',
