  ...
  it('ships the 18/18 evidence identity and strict source coverage', () => {
    ...
    expect(mechanicsPackage).toMatchObject({
      ...
      summary: {
        ...
        appliedEffectBindingCount: 1187,
        verifiedZeroEffectBindingCount: 7,
        unresolvedEffectBindingCount: 2487,
      ...
      battleEffectCatalog: {
        ...
        summary: {
          nodeCount: 3695,
          appliedNodeCount: 631,
          verifiedZeroNodeCount: 861,
          unresolvedNodeCount: 2203,
        },
      },
    ...
    expect(effectCoverage.summary).toMatchObject({
      ...
      appliedEffectBindingCount: 1186,
      verifiedZeroEffectBindingCount: 7,
      unresolvedEffectBindingCount: 2487,
      bindingKindCounts: {
        damage: 543,
