...
import {
  ...
  createMachineAxisEnemyProfileFromCompiledEnemy,
  ...
  it('builds the strict profile from level growth and the verified break source', () => {
    const profile = createMachineAxisEnemyProfileFromCompiledEnemy({
      enemy: {
        ...
        levelScaling: {
          ...
          source: {
            profileId: 'enemy-template:300032',
            templateId: 300032,
            templateValueId: 300032080,
          },
        },
        elementDefenses: [
          { attributeKey: 'ELEC_DEFENSE', baseValue: 0 },
          { attributeKey: 'WIND_DEFENSE', baseValue: 0 },
        ],
      },
      breakProfile: {
        enemyId: 300032,
        ...
        sourceIdentity: 'verified-break-profile:300032',
        ...
        weaknessDamageMinimum: -1,
        typeMultipliersBasisPoints: { physical: 10000, magic: 10000 },
        elementMultipliersBasisPoints: { 0: 10000, 2: 10000 },
      },
    });
    ...
    expect(profile).toMatchObject({
      ...
      attributes: {
        ...
        physicalDefense: 810,
        maxToughness: 26822.0077,
        elementDefenses: { ELEC_DEFENSE: 0, WIND_DEFENSE: 0 },
      },
      breakRules: {
        weaknessDamageMaximum: -1,
        weaknessDamageMinimum: -1,
    ...
    expect(validateMachineAxisEnemyProfile(profile)).toMatchObject({
      valid: true,
      issues: [],
    });
  });
