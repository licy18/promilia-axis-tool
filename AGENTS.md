...
- 当前 `5-8CO` 已把三值 calculator 定义、状态映射、未确认项和详情文案整理到 `src/simulation/threeValueCalculatorAdapters.js`，并让 runtime summary 暴露 calculator 诊断字段；下一步优先建立 Workbench 全局 calculator 诊断入口。
