...
const FIXTURE_PATH = 'fixtures/character-acceptance/199001-starborn-visual.json';
const FIXTURE_SHA256 =
  'da1cb1cf88d62fcb500bc85452ac9c980c20c8f1e7427c3196f631adb267bea2';
const TRACE_HASH = '9faf130f0dd529b7';
const SCREENSHOT_PATH = 'reports/m12-b3-199001-workbench-visual-evidence.png';
const SCREENSHOT_SHA256 =
  'f4f7fea0227dfed34c14bb746a4f9d4c373ba5acf5da50ceb652091291561f5a';

test('[m12-b3-199001-visual-evidence] imports the bound STARBORN female fixture and captures the canonical Workbench trace', async ({
  page,
}, testInfo) => {
  ...
  const ownerContract = await readJson(
    'src/data/generated/character-combat-owner-contracts/199001.json'
  );
  await installOwnerRuntimePackage(page, ownerContract, 199001);
  ...
  await page.getByTestId('workbench-import-project-file').setInputFiles({
    name: '199001-m12-b3-acceptance.json',
  ...
  const actionId = 'starborn-f-thrust-a3';
  const action = page
  ...
  await testInfo.attach('199001-current-workbench-capture', {
    body: currentCapture,
    contentType: 'image/png',
  });
  if (process.env.UPDATE_199001_VISUAL_EVIDENCE === '1') {
