...
| ultimate | 是 | applied-with-residual-gaps | effect-target-unresolved；effect-trigger-frame-missing；judgment-condition-runtime-unimplemented；nested-damage-trigger-lifecycle-not-expanded；nested-effect-wrapper-semantics-unresolved |
