...
| ultimate | 是 | applied-with-residual-gaps | effect-target-any-unresolved；effect-target-unresolved；effect-trigger-frame-missing；inject-wrapper-classified-through-child-edges；nested-damage-trigger-lifecycle-not-expanded；nested-effect-wrapper-semantics-unresolved；property-formula-not-literal-function-5 |
| star-carry | 是 | applied-with-residual-gaps | effect-target-unresolved；effect-trigger-frame-missing；inject-wrapper-classified-through-child-edges；nested-damage-trigger-lifecycle-not-expanded；nested-effect-wrapper-semantics-unresolved；property-formula-not-literal-function-5；verified-action-effective-occupancy-window-unresolved |
