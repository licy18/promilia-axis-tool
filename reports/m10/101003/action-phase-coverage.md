...
| ultimate | 是 | applied-with-residual-gaps | effect-target-unresolved；effect-trigger-frame-missing；nested-effect-wrapper-semantics-unresolved；property-formula-not-literal-function-5 |
| star-carry | 是 | applied-with-residual-gaps | effect-target-unresolved；effect-trigger-frame-missing；nested-effect-wrapper-semantics-unresolved；verified-action-effective-occupancy-window-unresolved |
