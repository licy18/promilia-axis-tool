...
| charged-attack | 是 | applied-with-residual-gaps | effect-target-unresolved；effect-trigger-frame-missing；pack-lifecycle-runtime-unimplemented；projectile-impact-frame-runtime-dependent；property-conditions-not-expanded；trigger-frame-missing |
