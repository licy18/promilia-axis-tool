...
- 公开动作变体：593（未解析 43）
- 非零回能元素：667（未关联 464）
- 零距离投射物命中：2443（仍缺发射帧 70、仍缺公式 7、仍缺目标 0）
...
| kibo | active | 122 | 122 | 122 | 0 | 0 | 1008 |
| kibo | break | 122 | 122 | 122 | 0 | 0 | 124 |
| kibo | signature | 122 | 122 | 122 | 0 | 0 | 687 |

## 未解析动作

- `actor|101003|10100301|0|10100303` 寒悠悠 / normal-attack / 鸢回影: trigger-frame-missing
- `actor|101003|10100322|1|10100325` 寒悠悠 / limit-counter / 缚风烟: trigger-frame-missing
- `actor|101010|10101001|0|10101003` 涂山小玉 / normal-attack / 画扇春: trigger-frame-missing
- `actor|103002|10300201|0|10300203` 红宝石 / normal-attack / 灵感的火花: trigger-frame-missing, normal-attack-input-segment-duration-unresolved
- `actor|107001|10700101|0|10700103` 西芙莉雅 / normal-attack / 疾风之箭: trigger-frame-missing, effect-trigger-frame-missing, normal-attack-input-segment-duration-unresolved
- `actor|107001|10700101|4|10700110` 西芙莉雅 / charged-attack / 疾风之箭: trigger-frame-missing
...
- `actor|108002|10800201|4|10800215` 璐璐卡 / dodge-attack / 涟漪之舞: trigger-frame-missing
